...
{
    public interface IGameLastUsingDateTimeService : ICreatable<GameLastUsingDateTime>,
        IReadable<GameLastUsingDateTime>,
        IUpdatable<GameLastUsingDateTime>,
        IReadableBySpecification<GameLastUsingDateTime>
    {
    }
}
